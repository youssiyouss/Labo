    ...
    <ul class="nav nav-tabs">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="{{ url('taches/MesTaches/'.$Projectid)}}">Mes taches</a>
              <a class="dropdown-item active" href="{{ url('taches/tousLesTaches/'.$Projectid)}}">Tous les taches</a>
...
<div class="col stretch-card">
  <div class="card">
    <div class="card-header">Tous les taches du projet</div>
    <div class="card-body">
